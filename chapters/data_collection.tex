...
\begin{table}[ht]
  ...
  \begin{tabular}{|c|c|}
    ...
    \hline
  \end{tabular}
  \caption{Comparison of Old and New Prompts' words appearing in the top 50 attention-receiving
  tokens}
...
\begin{figure}[ht!]
  ...
  \caption{Attention Difference between Old and New Prompts' 264 common tokens.
  Full resolution available in the repository \cite{projectrepo}.}
