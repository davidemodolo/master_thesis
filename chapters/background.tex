...
\ref{fig:bit_toggle_graphs}) grows exponentially with the number of bits. This
makes the problem of finding a solution in real-time almost impossible for a
moderate number of bits, and this is a basic problem.
