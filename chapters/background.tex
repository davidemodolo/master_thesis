...
\begin{figure}[h!]
  \centering
  \includegraphics[width=.3333\textwidth]{images/rl_scheme.png}
...
in parallel until the agent learns the best strategy. In fact, as we can see in the
Figure \ref{fig:rl_scheme}, the diagram defining the Reinforcement Learning
process remembers very closely the agent scheme presented in Figure
\ref{fig:agent_scheme}, where the agent interacts with the environment,
receiving feedback in the form of rewards and updating its policy to maximize
future rewards.
